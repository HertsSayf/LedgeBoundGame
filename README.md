# LedgeBoundGame
A repository for a game i created for the Software Development 2 Module, it is a 2D game inspired by the infamous 2D platformer ‘Mario’. 
...
Refrence Videos to help with developin the game:
